###########################################################################
## Makefile generated for component 'RollAxisAutopilot'. 
## 
## Makefile     : RollAxisAutopilot.mk
## Generated on : Fri Sep 04 12:52:40 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RollAxisAutopilot.exe
...
PRODUCT_NAME              = RollAxisAutopilot
MAKEFILE                  = RollAxisAutopilot.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2026A~1
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2026A~1/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/aloytyno/ONEDRI~1/DOCUME~1/MATLAB/Examples/R2026a/ecoder/GENERA~1/build/codegen
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = RollAxisAutopilot_comp.rsp
CMD_FILE                  = RollAxisAutopilot.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RollAxisAutopilot.exe
...
DEFINES_STANDARD = -DMODEL=RollAxisAutopilot -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/RollAxisAutopilot_ert_rtw/RollAxisAutopilot.c

MAIN_SRC = $(START_DIR)/RollAxisAutopilot_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/RollAxisAutopilot_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/RollAxisAutopilot_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/RollAxisAutopilot_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/RollAxisAutopilot_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/RollAxisAutopilot_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
RollAxisAutopilot.obj : $(START_DIR)/RollAxisAutopilot_ert_rtw/RollAxisAutopilot.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/RollAxisAutopilot_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
